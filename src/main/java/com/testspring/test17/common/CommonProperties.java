package com.testspring.test17.common;
...
public class CommonProperties {
	 ...
	 */
	//파일 업로드 경로
	public static final String FILE_UPLOAD_PATH = "C:\\java\\Spring\\work\\0826\\.metadata\\.plugins"
												  + "\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps"
												  + "\\SampleSpring\\resources\\upload";
	
	//파일 다운로드 경로
	public static final String FILE_DOWNLOAD_PATH = "http://localhost:8090/sample";
